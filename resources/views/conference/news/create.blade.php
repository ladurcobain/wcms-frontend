                ...
                <div class="card-body">
                    <form id="form" class="form-horizontal form-bordered" action="{{ route('news.store') }}"
                        ...
                        <div class="form-group row pt-3 pb-2">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Kategori <span class="required">*</span></label>
                            <div class="col-sm-9">
                                <select data-plugin-selectTwo class="form-control populate placeholder"
                        ...
                        <div class="form-group row pt-3 pb-2">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" data-plugin-datepicker data-provide="datepicker" data-date-end-date="0d" class="form-control" id="date" name="date" placeholder="Tanggal" autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group row pb-2">
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="link_youtube" name="link_youtube" placeholder="Tautan Youtube" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group row pb-2">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Tautan Instagram</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="link_instagram" name="link_instagram" placeholder="Tautan Instagram" autocomplete="off" />
                            </div>
                        </div>
