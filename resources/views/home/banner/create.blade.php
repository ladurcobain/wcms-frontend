    ...
    <div class="row">
        <div class="col">
            <section class="card card-featured card-featured-primary">
                ...
                <div class="card-body">
                    <form id="form" class="form-horizontal form-bordered" action="{{ route('banner.store') }}"
                        ...
                        <div class="form-group row pb-3">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Gambar <span class="required">*</span></label>
                            <div class="col-sm-9">
                                <input type="file" class="form-control" id="userfile" name="userfile" placeholder="Gambar" autocomplete="off" required />
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="title_in" name="title_in" placeholder="Judul Bhs. Indonesia" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group row pb-2">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Keterangan IN</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="subtitle_in" name="subtitle_in" rows="2" style="resize: none;" placeholder="Keterangan ..."></textarea>
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Judul Bhs. Inggris</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="title_en" name="title_en" placeholder="Judul Bhs. Inggris" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group row pb-2">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Keterangan EN</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="subtitle_en" name="subtitle_en" rows="2" style="resize: none;" placeholder="Keterangan ..."></textarea>
                            </div>
                        </div>
