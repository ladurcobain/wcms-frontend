                            ...
                            <div class="form-group row pt-3 pb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Nama" value="{{ $info->banner_name }}" autocomplete="off" required />
                                </div>
                            </div>
                            <div class="form-group row pb-3">
                                <label class="col-sm-3 control-label text-sm-end pt-2">Judul Bhs. Indonesia</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title_in" name="title_in"
                                        placeholder="Judul Bhs. Indonesia" value="{{ $info->banner_title_in }}"
                                        autocomplete="off" />
                                </div>
                            </div>
                            <div class="form-group row pb-2">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="subtitle_in" name="subtitle_in" rows="2" style="resize: none;"
                                        placeholder="Keterangan ...">{{ strip_tags($info->banner_subtitle_in) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row pb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title_en" name="title_en"
                                        placeholder="Judul Bhs. Inggris" value="{{ $info->banner_title_en }}"
                                        autocomplete="off" />
                                </div>
                            </div>
                            <div class="form-group row pb-2">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="subtitle_en" name="subtitle_en" rows="2" style="resize: none;"
                                        placeholder="Keterangan ...">{{ strip_tags($info->banner_subtitle_en) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row pb-3">
