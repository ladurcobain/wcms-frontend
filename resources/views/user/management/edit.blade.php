                            ...
                            <div class="tab-content">
                                <div id="general" class="tab-pane active">
                                    <form id="form" class="form-horizontal form-bordered"
                                        action="{{ route('management.update') }}" method="post" novalidate
                                        ...
                                        <div class="form-group row pb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="checkbox-custom checkbox-primary">
                                                    <input type="checkbox" id="checkboxExample2" name="status"
                                                        value="1" {{ $info->user_status == 1 ? 'checked' : '' }} />
                                        ...
                                        <div class="form-group row pb-3">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <img src="{{ $info->user_path }}" alt="Webphada"
                                                    class="img-thumbnail" />
                                                <?php } else { ?>
                                            ...
                                            <div class="col-sm-7">
                                                <input type="file" accept="image/jpg, image/png, image/jpeg"
                                                    class="form-control" id="userfile" name="userfile"
                                                    placeholder="File Gambar" autocomplete="off" />
                                                <span class="help-block">Ukuran maksimum 10MB (JPG | PNG | JPEG). Dimensi
                                                    gambar 200x200</span>
                                            </div>
                                        </div>
                                ...
                                <div id="password" class="tab-pane">
                                    <form id="form" class="form-horizontal form-bordered"
                                        ...
                                        <div class="form-group row pb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    value="{{ $info->user_account }}" readonly />
                                            </div>
                                        </div>
                                        <div class="form-group row pb-2">
                                            <label class="col-sm-3 control-label text-sm-end pt-2">Tipe</label>
                                        ...
                                        <div class="form-group row pb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    value="{{ $info->satker_name }}" readonly />
                                            </div>
                                        </div>
                                        <?php } ?>
                                        <hr />
                                        <div class="form-group row pt-3 pb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="password" class="form-control" id="password"
                                                    name="password" value="" placeholder="Kata Sandi Baru"
                                                    autocomplete="off" required />
                                            </div>
                                        </div>
                                        <div class="row justify-content-end">
