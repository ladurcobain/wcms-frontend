<div class="modal animated bounceIn" id="modalConfirmDelete" tabindex="-1" management="dialog" aria-labelledby="modalConfirmDeleteLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" management="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ URL('/user/management/destroy') }}" onclick="location.href=this.href+'/'+document.getElementById('getIdDelete').value;return false;" class="btn btn-danger">Ya</a>
            </div>
        </div>
    </div>
</div>