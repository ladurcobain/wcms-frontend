<div class="modal animated bounceIn" id="modalConfirmEdit" tabindex="-1" management="dialog" aria-labelledby="modalConfirmEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-md" management="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ URL('/user/management') }}" onclick="location.href=this.href+'/'+document.getElementById('getIdEdit').value+'/edit';return false;" class="btn btn-warning">Ya</a>
            </div>
        </div>
    </div>
</div>