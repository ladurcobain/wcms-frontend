        ...
        <div class="row">
            <div class="col">
                <section class="card card-featured card-featured-primary">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="pull-right">
                                    <a href="{{ route('patterns.index') }}" class="btn btn-sm btn-default" pattern="button">
                    ...
                    <div class="card-body">
                        <form id="form" class="form-horizontal form-bordered" action="{{ route('patterns.update') }}"
                            ...
                            <div class="form-group row pb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Nama" value="{{ $info->pattern_name }}" autocomplete="off" required />
                                </div>
                            </div>
                            <div class="form-group row pb-2">
