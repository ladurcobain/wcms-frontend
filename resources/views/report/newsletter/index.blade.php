        ...
        <div class="col">
            <section class="card card-featured card-featured-primary">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('newsletter.filter') }}" method="post">
                        ...
                        <div class="form-group row pb-1">
                            ...
                            <div class="col-lg-2">
                                ...
                                <a style="float:right;" href="{{ route('newsletter.index') }}" class="btn btn-sm btn-default mb-1 mt-1 me-1">Bersihkan</a>
                            </div>
                        </div> 
                    </form>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="center">
                                        ...
                                        <button type="button" OnClick="link_to('<?php echo 'report/newsletter/detail/'. $row->newsletter_id;  ?>');" class="btn btn-sm btn-info"><i class="fas fa-list-alt"></i> Detail</button>
                                    </td>
                                </tr>
                                <?php } ?>
                                <?php } else { ?>
