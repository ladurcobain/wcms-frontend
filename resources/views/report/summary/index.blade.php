        ...
        <div class="col">
            <section class="card card-featured card-featured-primary">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="{{ route('summary.filter') }}" method="post">
                        ...
                        <div class="form-group row pb-1">
                            ...
                            <div class="col-lg-2">
                                ...
                                <a style="float:right;" href="{{ route('summary.index') }}" class="btn btn-sm btn-default mb-1 mt-1 me-1">Bersihkan</a>
                            </div>
                        </div> 
                    </form>
                    <form id="frmUserExport" action="{{route('summary.excell')}}" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
