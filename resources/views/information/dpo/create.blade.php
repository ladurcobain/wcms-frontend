    ...
    <div class="row">
        <div class="col">
            <section class="card card-featured card-featured-primary">
                ...
                <div class="card-body">
                    <form id="form" class="form-horizontal form-bordered" action="{{ route('dpo.store') }}"
                        ...
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">Ukuran maksimum 10MB (JPG | PNG | JPEG). Dimensi gambar 400x600</span>
                            </div>
                        </div>
                        <div class="form-group row pb-2">
