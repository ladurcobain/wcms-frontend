                            ...
                            <div class="form-group row pt-3 pb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="title" name="title"
                                        placeholder="Nama" value="{{ $info->service_title }}" autocomplete="off" required />
                                </div>
                            </div>
                            <div class="form-group row pt-3 pb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="link" name="link"
                                        placeholder="Tautan" value="{{ $info->service_link }}" autocomplete="off"
                                        required />
                                </div>
                            </div>
