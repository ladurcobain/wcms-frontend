    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ URL('information/infrastructure') }}" onclick="location.href=this.href+'/'+document.getElementById('getIdEdit').value+'/edit';return false;" class="btn btn-warning">Ya</a>
            </div>
        </div>
    </div>
</div>