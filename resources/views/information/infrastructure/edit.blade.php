                ...
                <section class="card card-featured card-featured-primary">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="pull-right">
                                    <a href="{{ route('infrastructure.index') }}" class="btn btn-sm btn-default"
                    ...
                    <div class="card-body">
                        <form id="form" class="form-horizontal form-bordered"
                            action="{{ route('infrastructure.update') }}" method="post" novalidate
                                ...
                                <div class="col-sm-9">
                                    <div class="checkbox-custom checkbox-primary">
                                        <input type="checkbox" id="checkboxExample2" name="status" value="1"
                                            {{ $info->infrastructure_status == 1 ? 'checked' : '' }} />
                            ...
                            <div class="form-group row pt-3 pb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="Nama" value="{{ $info->infrastructure_name }}" autocomplete="off"
                                        required />
                                </div>
                            </div>
