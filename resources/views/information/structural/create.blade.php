    ...
    <div class="row">
        <div class="col">
            <section class="card card-featured card-featured-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('structural.index') }}" class="btn btn-sm btn-default" structural="button">
                ...
                <div class="card-body">
                    <form id="form" class="form-horizontal form-bordered" action="{{ route('structural.store') }}"
                        ...
                        <div class="form-group row pt-3 pb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="title" name="title" placeholder="Jabatan" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group row pb-3">
                            ...
                            <div class="col-sm-9">
                                ...
                                <span class="help-block">Ukuran maksimum 10MB (JPG | PNG | JPEG). Dimensi gambar 400x400</span>
                            </div>
                        </div>
                        <div class="form-group row pb-2">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Informasi Tambahan</label>
                            <div class="col-sm-9">
                                <textarea class="summernote form-control" id="information" name="information"></textarea>
                            </div>
                        </div>
