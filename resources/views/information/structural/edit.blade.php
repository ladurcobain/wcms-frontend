                ...
                <div class="card-body">
                    <form id="form" class="form-horizontal form-bordered" action="{{ route('structural.update') }}"
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox-custom checkbox-primary">
                                    <input type="checkbox" id="checkboxExample2" name="status" value="1" {{ ($info->structural_status == 1)? 'checked':'' }} />
                        ...
                        <div class="form-group row pt-3 pb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama" value="{{ $info->structural_name }}" autocomplete="off" required />
                            </div>
                        </div>
                        <div class="form-group row pt-3 pb-2">
                            <label class="col-sm-3 control-label text-sm-end pt-2">NIP</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nip" name="nip" placeholder="NIP" value="{{ $info->structural_nip }}" autocomplete="off" />
                            </div>
                        </div>
                        <div class="form-group row pt-3 pb-2">
                            <label class="col-sm-3 control-label text-sm-end pt-2">Jabatan</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="title" name="title" placeholder="Jabatan" value="{{ $info->structural_title }}" autocomplete="off" />
                            </div>
                        </div>
