                ...
                <div class="card-body">
                    ...
                    <div class="tabs tabs-dark">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6">
                                        <div class="thumb-info">
                                            <img src="{{ $info->user_path }}" alt="{{ $info->user_fullname }}" class="rounded img-fluid" /> 
                                            <div class="thumb-info-title">
                                                <span class="thumb-info-inner">{{ $info->user_fullname }}</span>
                                                <span class="thumb-info-type">{{ Status::tipeUser($info->user_type) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-9 col-md-6">
                                        <form id="form" class="form-horizontal form-bordered"
                                            action="{{ route('profile.update') }}" method="post" novalidate enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row pb-2">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="fullname" name="fullname" value="{{ $info->user_fullname }}" placeholder="Nama" autocomplete="off" required />
                                                </div>
                                            </div>
                                            <div class="form-group row pb-2">
                                                <label class="col-sm-3 control-label text-sm-end pt-2">Surel</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" id="email" name="email" value="{{ $info->user_email }}" placeholder="Surel" autocomplete="off" required />
                                                </div>
                                            </div>
                                            <div class="form-group row pb-2">
                            ...
                            <form id="form" class="form-horizontal form-bordered" action="{{ route('profile.password') }}"
                                ...
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" id="oldpassword" name="oldpassword" value=""
                                            placeholder="Kata Sandi Lama" autocomplete="off" required />
                                    </div>
                                </div>
                                <div class="form-group row pb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" id="newpassword" name="newpassword" value=""
                                            placeholder="Kata Sandi Baru" autocomplete="off" required />
                                    </div>
                                </div>
                                <div class="form-group row pb-3">
                                    <label class="col-sm-3 control-label text-sm-end pt-2">Konfirmasi Kata Sandi <span
                                            class="required">*</span></label>
                                    <div class="col-sm-9">
