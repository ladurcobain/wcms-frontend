    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ URL('integrity/mechanism/destroy') }}" onclick="location.href=this.href+'/'+document.getElementById('getIdDelete').value;return false;" class="btn btn-danger">Ya</a>
            </div>
        </div>
    </div>
</div>