                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('satker.index') }}" class="btn btn-sm btn-default" user="button">
                        ...
                        <div class="col-lg-3-5 col-xl-4-5">
                            <div class="tab-content" id="tabContent">
                                <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                                    <div class="card-body">
                                        <form id="form" class="form-horizontal form-bordered" action="{{ route('satker.updateinfo') }}" method="post" novalidate>
                                ...
                                <div class="tab-pane fade" id="medsos" role="tabpanel" aria-labelledby="medsos-tab">
                                    <div class="card-body">
                                        <form id="form" class="form-horizontal form-bordered" action="{{ route('satker.updatemedsos') }}" method="post" novalidate>
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                            <input type="hidden" name="satker_id" value="{{ $info->satker_id }}" />
                                            <div class="form-group row pb-2">
                                                <label class="col-sm-3 control-label text-sm-end pt-2">Url Map Google</label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" id="embed_map" name="embed_map" rows="2" style="resize: none;" placeholder="https://maps.google.com/maps?q=kejaksaan+agung+republik+indonesia&t=&z=10&ie=UTF8&iwloc=&output=embed">{{ $info->satker_map }}</textarea>
                                ...
                                <div class="tab-pane fade" id="support" role="tabpanel" aria-labelledby="support-tab">
                                    <div class="card-body">
                                        <form id="form" class="form-horizontal form-bordered" action="{{ route('satker.updatesupport') }}" method="post" novalidate>
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                            <input type="hidden" name="satker_id" value="{{ $info->satker_id }}" />
                                            <div class="form-group row pb-2">
                                ...
                                <div class="tab-pane fade" id="videos" role="tabpanel" aria-labelledby="videos-tab">
                                    <div class="card-body">
                                        <form id="form" class="form-horizontal form-bordered" action="{{ route('satker.updatevideos') }}" method="post" novalidate enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                            <input type="hidden" name="satker_id" value="{{ $info->satker_id }}" />
                                            <input type="hidden" name="old_videotype" value="{{ $info->satker_videotype }}" />
                                            <input type="hidden" name="old_videopath" value="{{ $info->satker_videopath }}" />
                                            <div class="form-group row pb-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            <div id="patternz" class="tab-pane <?php echo ($info->is_cover != 1)? 'active':'' ?>">
                                                <form id="form" class="form-horizontal form-bordered" action="{{ route('satker.updatepatterns') }}" method="post" novalidate enctype="multipart/form-data">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                                    <input type="hidden" name="satker_id" value="{{ $info->satker_id }}" />
                                ...
                                <div class="tab-pane fade" id="backgrounds" role="tabpanel" aria-labelledby="backgrounds-tab">
                                    <div class="card-body">
                                        <form id="form" class="form-horizontal form-bordered" action="{{ route('satker.updatebackgrounds') }}" method="post" novalidate enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                            <input type="hidden" name="satker_id" value="{{ $info->satker_id }}" />
                                            <div class="form-group row pb-2">
                                                <div class="row mg-files" data-sort-destination data-sort-id="media-gallery">
                                                        ...
                                                        <div class="thumbnail">
                                                            <div class="thumb-preview">
                                                                ...
                                                                <div class="mg-thumb-options">
                                                                    <div class="mg-toolbar">
                                                                        <div class="mg-option radio-custom radio-inline">
                                                                            <input type="radio" id="file_1" name="background" value="<?php echo $r->pattern_path; ?>" <?php echo ($info->satker_background == $r->pattern_path)? 'checked':'' ?> />
                                                                            <label for="file_1"><?php echo $r->pattern_name; ?></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="tab-content">
                        <div id="about" class="tab-pane <?php echo $tab_about; ?>">
                            <form id="form" class="form-horizontal form-bordered"
                                action="{{ route('satker.process') }}" method="post" novalidate>
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <input type="hidden" name="satker_id" value="{{ $info->satker_id }}" />
