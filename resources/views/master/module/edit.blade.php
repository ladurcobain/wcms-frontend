    ...
    <div class="row">
        <div class="col">
            <section class="card card-featured card-featured-primary">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="pull-right">
                                <a href="{{ route('module.index') }}" class="btn btn-sm btn-default" module="button">
                ...
                <div class="card-body">
                    <form id="form" class="form-horizontal form-bordered" action="{{ route('module.update') }}"
                        ...
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nama"
                                    value="{{ $info->module_name }}" autocomplete="off" required />
                            </div>
                        </div>
                        <div class="form-group row pb-2">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" id="desc" name="desc" rows="2" style="resize: none;"
                                    placeholder="Keterangan ...">{{ strip_tags($info->module_description) }}</textarea>
                            </div>
                        </div>
