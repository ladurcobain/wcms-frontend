...
class MasterCoverController extends Controller
{
    ...
    private $path = 'master/cover/search';
    ...
    public function index() {
        // unset session
		Session::forget('q');   
        return redirect()->route('cover.search');
	}
    ...
    public function search()
    {
        ...
        return view('master.cover.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('master.cover.create', $data);
    }
    ...
    public function edit($id)
    {
        ...
        if($res->status == true) {
            ...
            return view('master.cover.edit', $data);
        }
        else {
