...
class MasterPatternController extends Controller
{
    ...
    private $path = 'master/pattern/search';
    ...
    public function index() {
        // unset session
		Session::forget('q');   
        return redirect()->route('pattern.search');
	}
    ...
    public function search()
    {
        ...
        return view('master.pattern.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('master.pattern.create', $data);
    }
    ...
    public function edit($id)
    {
        ...
        if($res->status == true) {
            ...
            return view('master.pattern.edit', $data);
        }
        else {
