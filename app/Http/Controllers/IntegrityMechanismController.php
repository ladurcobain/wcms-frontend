...
class IntegrityMechanismController extends Controller
{
    ...
    private $path = 'integrity/mechanism/search';
    ...
    public function index() {
        ...
        return redirect()->route('mechanism.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/mechanism/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('integrity.mechanism.index', $data, compact('results'));
    }
    ...
    public function filter(Request $request)
    {
        if($request->has('_token')) {
            ...
            return redirect()->route('mechanism.index');
        }
    } 
    ...
    public function create()
    {
        ...
        return view('integrity.mechanism.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/mechanism/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/mechanism/get-single';
        $param = array('mechanism_id' => $id);
        $res = Curl::requestPost($url, $param);
        ...
        if($res->status == true) {
            ...
            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['mechanism']->satker_id) {
        ...
        return view('integrity.mechanism.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/mechanism/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/mechanism/delete-data';
