...
class IntegrityAccountabilityController extends Controller
{
    ...
    private $path = 'integrity/accountability/search';
    ...
    public function index() {
        ...
        return redirect()->route('accountability.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/accountability/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('integrity.accountability.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('integrity.accountability.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/accountability/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/accountability/get-single';
        $param = array('accountability_id' => $id);
        $res = Curl::requestPost($url, $param);

        if($res->status == true) {
            $data['status']  = $res->status;
            $data['message'] = $res->message;
            $data['accountability']    = $res->data; 

            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['accountability']->satker_id) {
        ...
        return view('integrity.accountability.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/accountability/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/accountability/delete-data';
