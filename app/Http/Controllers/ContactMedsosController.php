...
class ContactMedsosController extends Controller
{
    ...
    private $subtitle = "Media Sosial";
    private $path = 'contact/medsos/search';
    ...
    public function index() {
        ...
        return redirect()->route('medsos.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'contact/medsos/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('contact.medsos.index', $data, compact('results'));
    }
    ...
    public function filter(Request $request)
    {
        if($request->has('_token')) {
            ...
            return redirect()->route('medsos.index');
        }
    }
    ...
    public function create()
    {
        ...
        return view('contact.medsos.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'contact/medsos/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'contact/medsos/get-single';
        $param = array('medsos_id' => $id);
        $res = Curl::requestPost($url, $param);
        ...
        return view('contact.medsos.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'contact/medsos/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'contact/medsos/delete-data';
