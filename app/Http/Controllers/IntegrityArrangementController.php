...
class IntegrityArrangementController extends Controller
{
    ...
    private $subtitle = "Pentaan Tatalaksana";
    private $path = 'integrity/arrangement/search';
    ...
    public function index() {
        ...
        return redirect()->route('arrangement.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/arrangement/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('integrity.arrangement.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('integrity.arrangement.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/arrangement/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/arrangement/get-single';
        $param = array('arrangement_id' => $id);
        $res = Curl::requestPost($url, $param);

        if($res->status == true) {
            $data['status']  = $res->status;
            $data['message'] = $res->message;
            $data['arrangement']    = $res->data; 

            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['arrangement']->satker_id) {
        ...
        return view('integrity.arrangement.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/arrangement/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/arrangement/delete-data';
