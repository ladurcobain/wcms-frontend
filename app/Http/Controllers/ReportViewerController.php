...
class ReportViewerController extends Controller
{
    ...
    private $subtitle = "Statistik Pengunjung";
    private $path = 'report/viewer/search';
    ...
    public function index() {
        ...
        return redirect()->route('viewer.search');
	}
    ...
    public function search()
    {
        ...
        return view('report.viewer.index', $data, compact('results'));
    }
    ...
    public function download(Request $request)
    {
        ...
        if($res->status == true) {
            ...
            return redirect()->route('viewer.success');
        }
    }
}
