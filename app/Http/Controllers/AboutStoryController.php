...
class AboutStoryController extends Controller
{
    ...
    public function index() {
        ...
        return redirect()->route('story.search');
	}
    ...
    public function search()
    {
        ...
        return view('about.story.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('about.story.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/story/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/story/get-single';
        ...
        if($res->status == true) {
            ...
            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['story']->satker_id) {
        ...
        return view('about.story.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/story/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/story/delete-data';
