...
class InformationUnitController extends Controller
{
    ...
    private $path = 'information/unit/search';
    ...
    public function index() {
        ...
        return redirect()->route('unit.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'information/unit/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('information.unit.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('information.unit.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'information/unit/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'information/unit/get-single';
        $param = array('unit_id' => $id);
        $res = Curl::requestPost($url, $param);
        ...
        return view('information.unit.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'information/unit/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'information/unit/delete-data';
