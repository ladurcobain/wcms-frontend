...
class AboutDoctrinController extends Controller
{
    ...
    public function index() {
        ...
        return redirect()->route('doctrin.search');
	}
    ...
    public function search()
    {
        ...
        return view('about.doctrin.index', $data, compact('results'));
    }
    ...
    public function filter(Request $request)
    {
        if($request->has('_token')) {
            ...
            return redirect()->route('doctrin.index');
        }
    }
    ...
    public function create()
    {
        ...
        return view('about.doctrin.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/doctrin/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/doctrin/get-single';
        $param = array('doctrin_id' => $id);
        $res = Curl::requestPost($url, $param);

        if($res->status == true) {
            $data['status']  = $res->status;
            $data['message'] = $res->message;
            $data['doctrin']    = $res->data; 

            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['doctrin']->satker_id) {
        ...
        return view('about.doctrin.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/doctrin/update-data';
        
        $param = array(
            'doctrin_id'   => $request->doctrin_id,
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/doctrin/delete-data';
