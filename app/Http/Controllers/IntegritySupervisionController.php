...
class IntegritySupervisionController extends Controller
{
    ...
    private $path = 'integrity/supervision/search';
    ...
    public function index() {
        ...
        return redirect()->route('supervision.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/supervision/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('integrity.supervision.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('integrity.supervision.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/supervision/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/supervision/get-single';
        $param = array('supervision_id' => $id);
        $res = Curl::requestPost($url, $param);

        if($res->status == true) {
            $data['status']  = $res->status;
            $data['message'] = $res->message;
            $data['supervision']    = $res->data; 

            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['supervision']->satker_id) {
        ...
        return view('integrity.supervision.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/supervision/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/supervision/delete-data';
