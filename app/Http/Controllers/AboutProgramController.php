...
class AboutProgramController extends Controller
{
    ...
    public function index() {
        ...
        return redirect()->route('program.search');
	}
    ...
    public function search()
    {
        ...
        return view('about.program.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('about.program.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/program/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/program/get-single';
        ...
        if($res->status == true) {
            ...
            $data['program']    = $res->data; 

            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['program']->satker_id) {
        ...
        return view('about.program.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/program/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/program/delete-data';
