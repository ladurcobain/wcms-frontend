...
class HomeInfografisController extends Controller
{
    ...
    private $subtitle = "Infografis";
    private $path = 'home/infografis/search';
    ...
    public function index() {
        ...
        return redirect()->route('infografis.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'home/infografis/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('home.infografis.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('home.infografis.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'home/infografis/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'home/infografis/get-single';
        $param = array('infografis_id' => $id);
        $res = Curl::requestPost($url, $param);
        ...
        return view('home.infografis.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'home/infografis/update-data';
        ...
        if($request->hasFile('userfile')) {
            ...
            $response = $client->request('POST', $url, [
                ...
                'multipart' => [
                    ...
                    [
                        'name'      => 'infografis_id',
                        'contents'  => $request->infografis_id,
                    ],
                    [
                        'name'      => 'name',
                        'contents'  => $request->name,
                    ...
                    [
                        'name'      => 'infografis_image',
                        'contents'  => $request->infografis_image,
                    ],
                    [
                        'name'      => 'last_user',
                        'contents'  => Session::get('user_id'),
            ...
            $param = array(
                'infografis_id'    => $request->infografis_id,
                'infografis_image' => $request->infografis_image,
                'infografis_size'  => $request->infografis_size,
                'name'             => $request->name,
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'home/infografis/delete-data';
