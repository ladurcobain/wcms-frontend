...
class AboutCommandController extends Controller
{
    ...
    public function index() {
        ...
        return redirect()->route('command.search');
	}
    ...
    public function search()
    {
        ...
        return view('about.command.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('about.command.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/command/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/command/get-single';
        $param = array('command_id' => $id);
        $res = Curl::requestPost($url, $param);

        if($res->status == true) {
            $data['status']  = $res->status;
            $data['message'] = $res->message;
            $data['command']    = $res->data; 

            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['command']->satker_id) {
        ...
        return view('about.command.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/command/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/command/delete-data';
