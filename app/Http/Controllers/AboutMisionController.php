...
class AboutMisionController extends Controller
{
    ...
    private $path = 'home/mission/search';
    ...
    public function index() {
        ...
        return redirect()->route('mision.search');
	}
    ...
    public function search()
    {
        ...
        return view('about.mision.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('about.mision.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/mision/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/mision/get-single';
        $param = array('mision_id' => $id);
        $res = Curl::requestPost($url, $param);

        if($res->status == true) {
            $data['status']  = $res->status;
            $data['message'] = $res->message;
            $data['mision']    = $res->data; 

            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['mision']->satker_id) {
        ...
        return view('about.mision.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/mision/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/mision/delete-data';
