...
class IntegrityLegalController extends Controller
{
    ...
    private $path = 'integrity/legal/search';
    ...
    public function index() {
        ...
        return redirect()->route('legal.search');
	}
    ...
    public function search()
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/legal/get-all';
        $param = array(
            'limit'     => $perPage,
            'offset'    => $offset,
            'satker_id' => $satker,
        ...
        return view('integrity.legal.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('integrity.legal.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/legal/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/legal/get-single';
        $param = array('legal_id' => $id);
        $res = Curl::requestPost($url, $param);
        ...
        if($res->status == true) {
            ...
            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['legal']->satker_id) {
        ...
        return view('integrity.legal.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/legal/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'integrity/legal/delete-data';
