...
class AboutLogoController extends Controller
{
    ...
    public function index() {
        ...
        return redirect()->route('logo.search');
	}
    ...
    public function search()
    {
        ...
        return view('about.logo.index', $data, compact('results'));
    }
    ...
    public function create()
    {
        ...
        return view('about.logo.create', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/logo/insert-data';
    ...
    public function edit($id)
    {
        ...
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/logo/get-single';
        $param = array('logo_id' => $id);
        $res = Curl::requestPost($url, $param);
        ...
        if($res->status == true) {
            ...
            if(Session::get('user_type') == 2) {
                if(Session::get('satker_id') != $data['logo']->satker_id) {
        ...
        return view('about.logo.edit', $data);
    }
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/logo/update-data';
    ...
    {
        $uri = Curl::endpoint();
        $url = $uri .'/'.'about/logo/delete-data';
